            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/beheerder" aria-expanded="false"><i class="mdi mdi-face"></i><span class="hide-menu">Beheerder</span></a></li>
