                    ...
                    <ul id="sidebarnav">
                        ...
                        @auth
                            @if(Auth::user()->status == 2)
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/gebruikers" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">Gebruikers</span></a></li>
